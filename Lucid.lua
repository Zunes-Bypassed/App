...
local Themes = {
    ...
    Dark = {  
        ...
        AcrylicMain = Color3.fromRGB(25, 28, 35),  
        AcrylicBorder = Color3.fromRGB(45, 50, 60),  
        AcrylicGradient = ColorSequence.new{  
            ColorSequenceKeypoint.new(0, Color3.fromRGB(30, 32, 40)),  
            ColorSequenceKeypoint.new(1, Color3.fromRGB(45, 48, 55))  
        },  
        AcrylicNoise = 1,  

        TitleBarLine = Color3.fromRGB(60, 65, 75),  
        Tab = Color3.fromRGB(200, 210, 230),  

        Element = Color3.fromRGB(32, 35, 42),  
        ElementBorder = Color3.fromRGB(55, 60, 70),  
        InElementBorder = Color3.fromRGB(45, 50, 60),  
        ElementTransparency = 0.55,  

        ToggleSlider = Color3.fromRGB(180, 200, 255),  
        ToggleToggled = Color3.fromRGB(25, 28, 35),  

        SliderRail = Color3.fromRGB(90, 95, 110),  

        DropdownFrame = Color3.fromRGB(35, 38, 45),  
        DropdownHolder = Color3.fromRGB(28, 30, 38),  
        DropdownBorder = Color3.fromRGB(50, 55, 65),  
        DropdownOption = Color3.fromRGB(220, 225, 240),  

        Keybind = Color3.fromRGB(220, 225, 240),  

        Input = Color3.fromRGB(34, 36, 45),  
        InputFocused = Color3.fromRGB(26, 28, 36),  
        InputIndicator = Color3.fromRGB(180, 200, 255),  

        Dialog = Color3.fromRGB(30, 32, 40),  
        DialogHolder = Color3.fromRGB(38, 40, 48),  
        DialogButton = Color3.fromRGB(45, 48, 55),  
        DialogButtonBorder = Color3.fromRGB(55, 60, 70),  
        DialogBorder = Color3.fromRGB(65, 70, 80),  
        DialogInput = Color3.fromRGB(32, 34, 42),  
        DialogInputLine = Color3.fromRGB(180, 200, 255),  
    ...
    Light = {
        ...
        AcrylicMain = Color3.fromRGB(40, 35, 30),
        AcrylicBorder = Color3.fromRGB(60, 50, 45),
        AcrylicGradient = ColorSequence.new{
            ColorSequenceKeypoint.new(0, Color3.fromRGB(45, 40, 35)),
            ColorSequenceKeypoint.new(1, Color3.fromRGB(35, 30, 25)),
        },
        AcrylicNoise = 1,
    
        TitleBarLine = Color3.fromRGB(70, 60, 50),
        Tab = Color3.fromRGB(180, 140, 100),
    
        Element = Color3.fromRGB(55, 48, 40),
        ElementBorder = Color3.fromRGB(80, 70, 60),
        InElementBorder = Color3.fromRGB(65, 55, 45),
        ElementTransparency = 0.3,
    
        ToggleSlider = Color3.fromRGB(255, 170, 80),
        ToggleToggled = Color3.fromRGB(100, 80, 65),
    
        SliderRail = Color3.fromRGB(75, 65, 55),
    
        DropdownFrame = Color3.fromRGB(55, 48, 40),
        DropdownHolder = Color3.fromRGB(60, 50, 45),
        DropdownBorder = Color3.fromRGB(85, 70, 60),
        DropdownOption = Color3.fromRGB(220, 180, 140),
    
        Keybind = Color3.fromRGB(220, 180, 140),
    
        Input = Color3.fromRGB(65, 55, 45),
        InputFocused = Color3.fromRGB(75, 65, 55),
        InputIndicator = Color3.fromRGB(255, 170, 80),
    
        Dialog = Color3.fromRGB(55, 48, 40),
        DialogHolder = Color3.fromRGB(65, 55, 45),
        DialogButton = Color3.fromRGB(75, 65, 55),
        DialogButtonBorder = Color3.fromRGB(90, 75, 65),
        DialogBorder = Color3.fromRGB(70, 60, 50),
        DialogInput = Color3.fromRGB(60, 50, 40),
        DialogInputLine = Color3.fromRGB(255, 170, 80),
    
        Text = Color3.fromRGB(235, 220, 200),
        SubText = Color3.fromRGB(180, 160, 140),
        Hover = Color3.fromRGB(255, 190, 100),
        HoverChange = 0.05
    }
}
...
Components.Dialog = (function()
	...
	function Dialog:Create()
		...
		NewDialog.Scale = New("UIScale", { Scale = 1.05, Parent = NewDialog.Root })
		...
		function NewDialog:Button(Title, Callback)
			...
			Creator.AddSignal(Button.Frame.MouseButton1Click, function()
				Library:SafeCallback(Callback or function() end)
				NewDialog:Close()
			end)
			return Button
		end
...
Components.Notification = (function()
    ...
    function Notification:New(Config)
        ...
        function NewNotification:Open()
            ...
            RootMotor:setGoal({
                Offset = Spring(0, { frequency = 5, dampingRatio = 0.75 }),
                Opacity = Spring(0, { frequency = 5, dampingRatio = 0.75 }),
                Scale = Spring(1, { frequency = 5, dampingRatio = 0.75 }),
            })
        end
        ...
        function NewNotification:Close()
            if not NewNotification.Closed then
                ...
                task.spawn(function()
                    RootMotor:setGoal({
                        Offset = Spring(30, { frequency = 5, dampingRatio = 0.75 }),
                        Opacity = Spring(1, { frequency = 5, dampingRatio = 0.75 }),
...
function Element:New(Idx, Config)  
    ...
    Dropdown.ScrollFrame = DropdownScrollFrame
    ...
    local function RecalculateListPositionAndSize()
        ...
        local frameBottom = guiFrame and guiFrame.AbsolutePosition.Y + guiFrame.AbsoluteSize.Y or viewportY
    ...
    function Dropdown:BuildDropdownList()
        ...
        for _, Value in next, Dropdown.Values do
            ...
            }, { ButtonLabel, Creator.New("UICorner", { CornerRadius = UDim.new(0, 6) }) })  
